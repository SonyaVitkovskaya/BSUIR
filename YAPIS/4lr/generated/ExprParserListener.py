...
class ExprParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExprParser#or_func.
    def enterOr_func(self, ctx:ExprParser.Or_funcContext):
        pass

    # Exit a parse tree produced by ExprParser#or_func.
    def exitOr_func(self, ctx:ExprParser.Or_funcContext):
        pass
